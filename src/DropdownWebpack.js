...
import templates from './DropdownWebpack.soy.js';

/**
 * DropdownWebpack component.
 */
class DropdownWebpack extends Component {
	/**
	 * @inheritDoc
	 */
	attached() {
...
Soy.register(DropdownWebpack, templates);
...
export default DropdownWebpack;
export { DropdownWebpack };